                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="proses_dashboard_admin.php" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" name="tgl_lahir" id="LtglLahir" value="<?= date('d-m-y', strtotime($data['tgl_lahir'])) ?>" autocomplete="off">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="mapel" class="form-select" aria-label="Default select" id="Lmapel">
                            ...
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select" id="Lmapel" name="mapel">
                                        <option disabled selected value="">Pilih Mapel Guru</option>
                                        <option value="Pemrogaman Dasar">Pemrograman Dasar</option>
                                        <option value="Dasar Desain Grafis">Dasar Desain Grafis</option>
                                        <option value="Internet Of Things">Internet Of Things</option>
                                        <option value="Pendidikan Kewirausahaan">Pendidikan Kewirausahaan</option>
